export default function Component() {
  return (
    <div className="min-h-screen text-white" style={{backgroundColor:'#131a29'}}>
      <div className="container mx-auto px-6 py-16 max-w-4xl">
        <article className="space-y-8">
          <header className="space-y-4">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">Eytrix Acquired by Meta</h1>
          </header>

          <div className="prose prose-lg prose-invert max-w-none space-y-6">
            <p className="text-xl leading-relaxed text-gray-300">
              In August 2025, Eytrix joined Meta, a global leader at the forefront of AI innovation, connectivity, and immersive technologies.
            </p>
